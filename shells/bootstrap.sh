...
Examples:
  curl -L https://raw.githubusercontent.com/ZiYyun/ZiYyun-NixOSConfiguration/main/shells/bootstrap.sh | sudo bash
...
exec bash "${workdir}/shells/install.sh" "${install_args[@]}"
